  ...
  async function test(kind: NotificationKind) {
    ...
    try {
      ...
      if (res.status === "sent") toast.success("Đã gửi thử lên Discord ✓");
        ...
        toast.error(`Gửi thất bại: ${res.detail}`);
      ...
      <section className="space-y-3">
        <div className="flex items-center gap-1.5">
          ...
          <InfoHint label="Cường độ là gì?">
            Đặt nhanh tổ hợp loại thông báo. Bạn vẫn chỉnh từng loại bên dưới
            sau khi chọn.
          </InfoHint>
        </div>
      ...
      <section className="space-y-3">
        <div className="flex items-center gap-1.5">
          ...
          <InfoHint label="Giờ yên là gì?">
            Trong khoảng này app không gửi bất kỳ thông báo nào (kể cả tới giờ
            đã đặt). Có thể vắt qua nửa đêm, vd 22:00 → 07:00.
          </InfoHint>
        </div>
